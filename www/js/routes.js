routes = [
  ...
  {
    path: "/about/",
    componentUrl: "./pages/app/about.html"
  },
            ...
            routes: [
              {
                path: "/gcodes",
                componentUrl:
                    "./pages/pr/sinumerik/sinumerik-milling-gcodes.html"
              },
              {
                path: "/gcodes/:id",
                componentUrl:
                    "./pages/pr/sinumerik/sinumerik-milling-gcodes-view.html"
              }
            ]
          }
        ]
        ...
        routes: [
          {
            ...
            routes: [
              ...
              {
                path: "/cycle-g70/",
                url: "./pages/pr/fanuc/cycle-g70.html"
              },
              {
                path: "/cycle-g71/",
              ...
              {
                path: "/cycle-g73/",
                url: "./pages/pr/fanuc/cycle-g73.html"
              },
              {
                path: "/cycle-g74/",
              ...
              {
                path: "/cycle-g76-2/",
                url: "./pages/pr/fanuc/cycle-g76-2.html"
              },
  ...
  {
    path: "/calc/turning/",
    componentUrl: "./pages/calc/calc-turning.html"
  },
  {
    path: "/calc/milling/",
    componentUrl: "./pages/calc/calc-milling.html"
  },
  {
    path: "/calc/drilling/",
    componentUrl: "./pages/calc/calc-drilling.html"
  },
  {
    path: "/calc/roughness_turn/",
    componentUrl: "./pages/calc/calc-roughness-turn.html"
  },
